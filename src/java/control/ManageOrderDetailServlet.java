 ...
 * @author ASUS
 */
@WebServlet(name = "ManageOrderDetailServlet", urlPatterns = {"/manageorderdetail"})
public class ManageOrderDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderedProduct> orderedproducts = orderedDAO.getOrderedProduct(oid);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManageOrderDetailServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
